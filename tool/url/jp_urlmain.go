...
func main() {
	if lizard.Local {
		core.InitConfig(lizard.Dir+"/config/"+"jp_local_config.json", lizard.Dir+"/config/"+"jp_log.json")
	} else {
		core.InitConfig(lizard.Dir+"/config/"+"jp_config.json", lizard.Dir+"/config/"+"jp_log.json")
	}
