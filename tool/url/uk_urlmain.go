...
func main() {
	if lizard.Local {
		core.InitConfig(lizard.Dir+"/config/"+"uk_local_config.json", lizard.Dir+"/config/"+"uk_log.json")
	} else {
		core.InitConfig(lizard.Dir+"/config/"+"uk_config.json", lizard.Dir+"/config/"+"uk_log.json")
	}
